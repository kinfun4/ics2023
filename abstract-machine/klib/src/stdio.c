...
#define PROCESS_SIGNED(out, ap)                                                \
  do {                                                                         \
    ...
    do {                                                                       \
      ...
      assert(buf_pt - buf < PRINTF_BUF_SIZE);                                  \
      x /= base;                                                               \
    } while (x != 0);                                                          \
    if (is_negtive)                                                            \
      space--;                                                                 \
...
#define PROCESS(out, fmt, ap)                                                  \
  do {                                                                         \
    ...
    case 'c':                                                                  \
      ...
      break;                                                                   \
    case 's':                                                                  \
      PROCESS_STRING(out, ap);                                                 \
      fmt++;                                                                   \
      break;                                                                   \
    case 'd':                                                                  \
      PROCESS_SIGNED(out, ap);                                                 \
      fmt++;                                                                   \
      break;                                                                   \
    case 'i':                                                                  \
      PROCESS_SIGNED(out, ap);                                                 \
