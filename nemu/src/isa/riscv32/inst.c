...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // INSTPAT("0000000 00001 ????? 011 ????? 00100 11", seqz  , I, R(rd) = src1 < 1 ? 1 : 0);
  ...
  // INSTPAT("0000000 00000 00001 000 00000 11001 11", ret    , I, s->dnpc = (src1 + imm) - ((src1 + imm) & 1));
  INSTPAT("??????? ????? ????? 000 ????? 11001 11", jalr   , I, s->dnpc = (src1 + imm) - ((src1 + imm) & 1), R(rd) = s->pc + 4);
